...
class NaverWeather():
      ...
      def parse_html(self, text):
            ...
            part_sensible = html.find('span', {'class': 'sensible'})
            sub_sensible = part_sensible.find('em')
            sensible = sub_sensible.find('span', {'class': 'num'})
            sensible = sensible.string if sensible else sensible
            #sensible는 체감온도
